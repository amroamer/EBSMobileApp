...
define(['ojs/ojcore','knockout',
  ...
  function(oj,ko, app) {
    function RequestApproversListViewModel(params) {
      var self = this;
	   self.val= ko.observable();
	     self.currentColor = ko.observable("red");
		 
		 console.log("RequestApproversListViewModel");
	   ...
	   self.noOfCopiesLbl = ko.observable(oj.Translations.getTranslatedString("noOfCopies"));
		...
		self.addRequestLbl = ko.observable(oj.Translations.getTranslatedString("addRequest"));
			...
			self.saveAndSubmitBtnLbl = ko.observable(oj.Translations.getTranslatedString("saveAndSubmit"));
    ...
    return RequestApproversListViewModel;
  });
